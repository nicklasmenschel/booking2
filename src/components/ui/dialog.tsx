...
>(({ className, children, showClose = true, ...props }, ref) => (
    <DialogPortal>
        ...
        <DialogPrimitive.Content
            ref={ref}
            className={cn(
                "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border-2 border-border bg-background p-6 shadow-xl duration-200 sm:rounded-2xl",
            ...
            {open && (
                <>
                    ...
                    <motion.div
                        ...
                        className={cn(
                            "fixed left-[50%] top-[50%] z-50 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-2xl border-2 border-border bg-background p-6 shadow-xl",
                            className
                        )}
                    >
                        <button
