...
export function WaitlistTab({ waitlist, offering, instances }: WaitlistTabProps) {
    const getInstanceLabel = (instanceId: string) => {
        const instance = instances.find(i => i.id === instanceId);
        if (!instance) return "Unknown";
        return `${formatDate(instance.date)} at ${formatTime(instance.startTime)}`;
    };
            ...
            {waitlist.length === 0 ? (
                <Card className="p-12 text-center">
                    ...
                    <p className="text-muted-foreground">
                        When your event sells out, guests can join the waitlist here.
                    </p>
                </Card>
            ) : (
                <>
                        ...
                        <div className="flex items-start gap-3">
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-blue-700">
                                    When a spot opens up, waitlist #1 is automatically notified. They have 24 hours
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="space-y-1 text-sm text-muted-foreground">
                                                ...
                                                <p className="flex items-center gap-2">
                                                    ...
                                                    Requested: {getInstanceLabel(entry.instanceId)}
                                                </p>
                                                <p className="flex items-center gap-2">
                                                    <Clock className="h-3 w-3" />
